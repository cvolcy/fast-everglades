...
var app = new Vue({
    ...
    mounted: async function() {
        await this.checkForRain();
        this.$nextTick(() => {
            var context = this;
            window.addEventListener('resize', function() {
                context.useJumboHeader = (document.body.clientWidth * document.body.clientHeight > 438000);
            });
        });
    },

    methods: {
        notifyMe: function(message, silent) {
        ...
        checkForRain: async function () {
            ...
            this.headerText = shouldBringUmbrella ? "You should bring your umbrella" : "You should not need your umbrella today";
            this.msgText = shouldBringUmbrella ? "Looks like it might rain today, you should bring your umbrella today" : "The forecast predicts that it should not be a rainy day";
    
            this.notifyMe(this.headerText, !shouldBringUmbrella);
            ...
            setTimeout(this.checkForRain, nextCheck);
        }
    }
});